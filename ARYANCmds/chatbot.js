...
async function handleAIChatbot(m, bot, body, from, isGroup, isCmd, prefix) {
    try {
        ...
        if (isAskingAboutCreator) {
            ...
            response = "I am ORMAN AI, created by KING ORMAN- a brilliant developer from Uganda with exceptional coding skills and vision. He's the mastermind behind my existence, crafting me with precision and care to be your helpful assistant.";
        } else {
            ...
            const prompt = `You are Orman xmd AI, a powerful WhatsApp bot developed from Uganda. 
